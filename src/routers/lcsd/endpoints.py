...
# ── NEW HTML routers (2025-07-13 change-request) ────────────────────────────
from .html_timetable_endpoints import router as _html_tt_form_router
from .html_dashboard_endpoints import router as _html_dash_router
from .html_dashboard_monthview_endpoints import router as _html_dash_mv_router
...
# newly added HTML routes
router.include_router(_html_tt_form_router)
router.include_router(_html_dash_router)
router.include_router(_html_dash_mv_router)
