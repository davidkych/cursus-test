...
/* ─────────────────────────── NEW: Redeem code ─────────────────────────────── */
/**
 * Redeem a code generated by the backend code generator.
 * Expects Authorization bearer token.
 * Returns { is_admin, is_premium_member, applied }
 */
export async function redeemCode(code) {
  ...
  if (MOCK) {
    // In mock mode, simulate success and toggle premium flag in caller's refresh.
    return Promise.resolve({ is_admin: false, is_premium_member: true, applied: true })
  }
