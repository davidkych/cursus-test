...
import { useUserMode } from '@/stores/userMode.js'      // ← NEW
...
const userMode = useUserMode()                          // ← NEW
...
const handleStyleChange = (slug) => {
  ...
  // ── updated routing: honour public/admin prefixes ───────────
  router.push(userMode.isAdmin ? '/admin/dashboard' : '/public/dashboard')
}
</script>
